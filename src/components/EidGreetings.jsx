...
function EidGreetings() {
	...
	return (
		<div>
			<div className="py-3 px-3 bg-emerald-800 text-white text-sm relative"><span className="ml-3">After a month of long fastings</span><br/><span className="ml-3">Eid has been reached to us at the end!</span>
				<div className="animatedDiv absolute w-[25px] h-[100%] bg-emerald-800/50 left-0 top-0"></div>
			</div><div className="h-1">
			</div>
			<img src={img} alt="eid image"/>
			...
			<div style={{display: "none"}} className="msg mx-3 px-1 text-sm text-emerald-700 relative">
			...
			<div><img className="animated" src={animated} alt="animated image"/></div>
			<audio style={{display: "none"}} controls autoPlay loop>
				<source src={bgSong} type="audio/mpeg"/>
			</audio>
			<div className="mt-4 pb-3 flex items-center justify-center mx-auto text-xs text-emerald-700 font-bold">Eidul-Fitr 2025</div>
		</div>
	)
}
